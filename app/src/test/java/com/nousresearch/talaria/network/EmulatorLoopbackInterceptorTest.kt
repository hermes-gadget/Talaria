...
import com.nousresearch.talaria.core.network.EmulatorLoopbackInterceptor
...
class EmulatorLoopbackInterceptorTest {
    ...
    fun okHttpStillBuilds() {
        // Smoke: interceptor is attachable to a real client builder.
        OkHttpClient.Builder().addNetworkInterceptor(EmulatorLoopbackInterceptor()).build()
    }
}
